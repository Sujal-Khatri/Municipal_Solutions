...
from .models import DiscussionPost, PostReaction, Notice, Report, SelfAssessmentReturn, Hospital
...
def free_health_services(request):
    hospitals = Hospital.objects.all().order_by('id')
    return render(request, 'services/free_health_services.html', {
        'hospitals': hospitals
    })
